...
class ApiService {
  ...
  static Future<Map<String, dynamic>> resendOTP({
    required String email, String type = 'verify',
  }) async {
  ...
  static Future<Map<String, dynamic>> resetPassword({
    required String email, required String resetToken, required String newPassword,
  }) async {
  ...
  static Future<Map<String, dynamic>> createProperty({
    required String propertyType, required String propertyName,
    required String location, String localLandmark = '',
    required Map<String, dynamic> details,
  }) async {
    final body = {
      'propertyType': propertyType, 'propertyName': propertyName,
      'location': location, 'localLandmark': localLandmark, ...details,
    };
  ...
  static Future<Map<String, dynamic>> getMyProperties({String? status, String? type}) async {
  ...
  static Future<Map<String, dynamic>> getDashboardStats() async {
    final res = await http.get(Uri.parse('$baseUrl/properties/dashboard'), headers: await _headers());
    return _handle(res);
  }

  static Future<Map<String, dynamic>> updatePropertyStatus(String id, String status) async {
  ...
  static Future<Map<String, dynamic>> deleteProperty(String id) async {
    final res = await http.delete(Uri.parse('$baseUrl/properties/$id'), headers: await _headers());
    return _handle(res);
  }

  // ── VISITS ───────────────────────────────────────────────
  static Future<Map<String, dynamic>> getVisits({String? category, String? status}) async {
  ...
  static Future<Map<String, dynamic>> confirmVisit(String id) async {
    final res = await http.patch(Uri.parse('$baseUrl/visits/$id/confirm'), headers: await _headers());
    return _handle(res);
  }

  static Future<Map<String, dynamic>> rescheduleVisit(String id,
      {required String newDate, required String newTime, String reason = ''}) async {
    final res = await http.patch(Uri.parse('$baseUrl/visits/$id/reschedule'),
        headers: await _headers(),
        body: jsonEncode({'newDate': newDate, 'newTime': newTime, 'reason': reason}));
    return _handle(res);
  }

  static Future<Map<String, dynamic>> cancelVisit(String id, String reason) async {
  ...
  static Future<void> markAllRead() async {
    await http.patch(Uri.parse('$baseUrl/notifications/read-all'), headers: await _headers());
  }

  static Future<void> clearNotifications() async {
    await http.delete(Uri.parse('$baseUrl/notifications/clear'), headers: await _headers());
  }
  ...
  static Future<Map<String, dynamic>> getChatMessages(String chatId) async {
    final res = await http.get(Uri.parse('$baseUrl/messages/$chatId'), headers: await _headers());
    return _handle(res);
  }

  static Future<Map<String, dynamic>> sendReply(String chatId, String text) async {
  ...
  static Future<Map<String, dynamic>> uploadDocuments({
    ...
    if (registryBytes != null) {
      request.files.add(http.MultipartFile.fromBytes(
        ...
        contentType: MediaType.parse(_mimeFor(registryFileName ?? 'registry.pdf')),
      ));
    }
    if (nocBytes != null) {
      request.files.add(http.MultipartFile.fromBytes(
  ...
  static Future<Map<String, dynamic>> getOwnerChats() async {
    final res = await http.get(Uri.parse('$baseUrl/customers/owner-chats'), headers: await _headers());
    return _handle(res);
  }

  static Future<Map<String, dynamic>> getOwnerChatMessages(String chatId) async {
    final res = await http.get(Uri.parse('$baseUrl/customers/owner-chats/$chatId/messages'), headers: await _headers());
    return _handle(res);
  }

  static Future<Map<String, dynamic>> ownerSendMessage({
    required String chatId, required String text, String? imageUrl, String? linkUrl,
  }) async {
    final res = await http.post(Uri.parse('$baseUrl/customers/owner-chats/$chatId/messages'),
        headers: await _headers(),
        body: jsonEncode({'text': text, if (imageUrl != null) 'imageUrl': imageUrl, if (linkUrl != null) 'linkUrl': linkUrl}));
    return _handle(res);
  }

  static Future<Map<String, dynamic>> ownerPollMessages(String chatId, String since) async {
  ...
  static Future<Map<String, dynamic>> confirmVisitOwner(String id, {String note = ''}) async {
    final res = await http.patch(Uri.parse('$baseUrl/visits/$id/confirm'),
        headers: await _headers(), body: jsonEncode({'ownerNote': note}));
    return _handle(res);
  }

  static Future<Map<String, dynamic>> cancelVisitOwner(String id, String reason) async {
    final res = await http.patch(Uri.parse('$baseUrl/visits/$id/cancel'),
        headers: await _headers(), body: jsonEncode({'reason': reason}));
    return _handle(res);
  }
  ...
  static Future<Map<String, dynamic>> getVisitById(String id) async {
    final res = await http.get(Uri.parse('$baseUrl/visits/$id'), headers: await _headers());
    return _handle(res);
  }
  ...
  static Future<Map<String, dynamic>> uploadOwnerChatAudio({
    ...
    final uri = Uri.parse('$baseUrl/customers/owner-chats/$chatId/upload-audio');
  ...
  static Future<Map<String, dynamic>> scheduleVisitOwner({
    ...
    final res = await http.post(
      ...
      headers: await _headers(),
      body: jsonEncode({
        'propertyId': propertyId, 'visitorName': visitorName,
        'visitorPhone': visitorPhone, 'visitDate': visitDate,
        'visitTime': visitTime, 'requirement': requirement,
  ...
  static Future<Map<String, dynamic>> sendVisitNote(String id, String note) async {
    final res = await http.patch(
